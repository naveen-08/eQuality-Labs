...
.btn-primary{color:#3366FF;}
.regHeader{color:#3366FF;}
...
.btn-link:hover{color:#e9e9e9;text-decoration:underline;}
.sign-in-box{border:1px solid black;border-radius: 3px; box-shadow: 6px 4px #grey; }
.loader-div {
	margin: -50px 0 0 38%;
	border-radius: 2px; /* margin: 290px 0 0 50%; */
	display: none;
	opacity: 1.0;
	position: absolute;
}
...
<div class="row ">
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		<form id ="loginFormId" action="#" method="post" model="user" accept-charset="UTF-8">
		
			<fieldset class="sign-in-box">
		   <div style="color:#3366FF;"><h2 class="regHeader">Please Sign In</h2> </div>
				<hr class="colorgraph">
				...
				<div class="row">
					<div class="col-xs-6 col-sm-6 col-md-6">
                        <input type="submit" id="loginSubmit" name="loginSubmit" class ="btn btn-success btn-block btn-lg"
                        value="Sign In">
					</div>
					<div class="col-xs-6 col-sm-6 col-md-6">
						<a href="${pageContext.request.contextPath}/signup.html" class="btn btn-lg btn-primary btn-block">Register</a>
					</div>
				</div>
			</fieldset>
		</form>
...
$(document).ready(function(e) {
	...
	$("#loginSubmit").click(function(e) {
		$(".loader-div").show();
		$("#loginValidationMessage").css('color', 'white');
