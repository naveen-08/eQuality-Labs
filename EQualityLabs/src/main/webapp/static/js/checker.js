   ...
   /* var enableClickablesAndHideSpinner = function (spinnerID) {
    ...
    AChecker.input.validateURI = function () {
        ...
        /*disableClickablesAndShowSpinner(inputDivMapping.AC_by_uri.spinnerID);*/
				/*alert("please login with your account, report will be sent to your mail id"); */
				/*$("#url_msg").text("please login with your account, report will be sent to your mail id."); 
						//alert("emaild should not be left blank");
				document.getElementById("checkuri").focus();*/
				return false;
    };
     ...
     */
    AChecker.input.validateUpload_pdf = function () {
        // check file type
		...
		AChecker.input.validateUpload_doc = function () {
        // check file type
        var upload_file = document.getElementById("checkfile1").value;
        if (!upload_file || upload_file.trim() === '') {
            alert("please enter .doc (or) .docx file ");
            return false;
        }
        var file_extension = upload_file.slice(upload_file.lastIndexOf(".")).toLowerCase();
        if (file_extension !== '.doc') {
            alert("please upload .doc (or) .docx file only !");
            return false;
        }
       };
		
		AChecker.input.validateUpload_ppt = function () {
        // check file type
        var upload_file = document.getElementById("checkfile2").value;
        if (!upload_file || upload_file.trim() === '') {
            alert("please enter .ppt ");
            return false;
        }
        var file_extension = upload_file.slice(upload_file.lastIndexOf(".")).toLowerCase();
        if (file_extension !== '.pptx' ) {
            alert("please upload .pptx file only !");
            return false;
        }
        /*disableClickablesAndShowSpinner(inputDivMapping.AC_by_upload.spinnerID);*/
